...
**_Few notes:_**
- The CLI now supports two testing component library templates [Enzyme](https://airbnb.io/enzyme) & [Testing Library](https://testing-library.com) that work with [Jest](https://github.com/facebook/jest) as the test driver.
